...
Our excitment about this revolutionary approach of MTM led us to form a partnership, register our company, and begin our work on simplePDM - a web site that would allow pattern makers to digitally manage their files, catalogues, and collections. We created [this video](https://www.youtube.com/watch?v=cMj1w3Sx9_U) (and we mean _we created_ - we wrote, drew, recorded and edited all on our own back in those days) to help understand the concept. Essentially, it's like Google Docs, but specific for the textile and garment industry.

The technological decision to go with Drupal, we equally owe to a good investment of time in finding the right technology, and to pure luck. At the time, it seemed better than the other options, where today most of them don't event exist.
