...
Then you might see that even though the data exists after your fix, it still doesn't appear. You might find that indeed there was some problem in the view related code.
