...
**Solution**: Check if it is even invoked. Again, no need to have a very delicate debugging. Instead trace the places the code is being called and figure out if is indeed called
