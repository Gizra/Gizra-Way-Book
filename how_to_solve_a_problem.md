...
With the exception of an urgent bug on a production site, sometimes a complicated problem needs to be put down. That is, while still being inside the timeboxed range, you may decide to let things go.
